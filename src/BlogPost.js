...
=======
        { 
        <div className="comment"><Comment commentText={comments[0]} /><div>
        <div className="comment"><Comment commentText={comments[1]} /><div>
        <div className="comment"><Comment commentText={comments[2]} /><div>
